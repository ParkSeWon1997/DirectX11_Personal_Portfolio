...
void CBounding_AABB::SetBoxSize(_float3& vSize)
{
...
_float3 CBounding_AABB::Compute_Min(const BoundingBox* pTargetBounding)
{
	return _float3{ pTargetBounding->Center.x - pTargetBounding->Extents.x,
	pTargetBounding->Center.y - pTargetBounding->Extents.y,
	pTargetBounding->Center.z - pTargetBounding->Extents.z };
}

_float3 CBounding_AABB::Compute_Max(const BoundingBox* pTargetBounding)
{
	return _float3{ pTargetBounding->Center.x + pTargetBounding->Extents.x,
		pTargetBounding->Center.y + pTargetBounding->Extents.y,
		pTargetBounding->Center.z + pTargetBounding->Extents.z };
