...
{
public:
	enum RENDERGROUP { RENDER_PRIORITY, RENDER_SHADOWOBJ, RENDER_MASK, RENDER_NONBLEND, RENDER_NONLIGHT, RENDER_BLEND,RENDER_EFFECT, RENDER_POST,RENDER_UI, RENDER_END };
