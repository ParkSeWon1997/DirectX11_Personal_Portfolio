...
void CStage::Priority_Tick(_float fTimeDelta)
{
}
...
void CStage::Late_Tick(_float fTimeDelta)
{
...
HRESULT CStage::Add_Components()
{
	...
	if (FAILED(__super::Add_Component(CLoader::m_eNextLevel, TEXT("Prototype_Component_Shader_Mesh_Stage_SM"),
