...
HRESULT CLevel_Stage_1::Ready_Player_SKill_UI(const wstring& strLayerTag)
{
	UI::UI_DESC desc;
	...
	desc.fY = 580.f;
	desc.iPassIndex = 6;
	if (FAILED(m_pGameInstance->Add_CloneObject(LEVEL_STAGE_1, strLayerTag, TEXT("Prototype_GameObject_UI_PlayerSkill"), &desc)))
		return E_FAIL;
...
HRESULT CLevel_Stage_1::Ready_Boss_UI(const wstring& strLayerTag)
{
	UI::UI_DESC desc;
