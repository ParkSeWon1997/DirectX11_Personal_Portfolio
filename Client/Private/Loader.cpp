...
#pragma region TEXTURE
	...
	/*Ui.Player.Icon*/
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Matilda_Icon"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Ui/PlayerIcon/Chara_Portrait_SM.png"), 1))))
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Amanda_Icon"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Ui/PlayerIcon/Chara_Portrait_GS.png"), 1))))
		return E_FAIL;
...
#pragma region MODEL
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Sequence_M_130525"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Models/Sequence_M_130525/Sequence_M.fbx"))))
		return E_FAIL;
...
HRESULT CLoader::Loading_For_Stage_1()
{
	...
	/*Ui.Player.Icon*/
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STAGE_1, TEXT("Matilda_Icon"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Ui/PlayerIcon/Chara_Portrait_SM.png"), 1))))
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STAGE_1, TEXT("Amanda_Icon"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Ui/PlayerIcon/Chara_Portrait_GS.png"), 1))))
		return E_FAIL;
...
HRESULT CLoader::Loading_For_Stage_2()
{
	...
	/*Ui.Player.Icon*/
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STAGE_2, TEXT("Matilda_Icon"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Ui/PlayerIcon/Chara_Portrait_SM.png"), 1))))
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_STAGE_2, TEXT("Amanda_Icon"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Ui/PlayerIcon/Chara_Portrait_GS.png"), 1))))
		return E_FAIL;
...
HRESULT CLoader::Loading_For_Change_Stage()
{
	...
	/*Ui.Player.Icon*/
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_CHANGE_STAGE, TEXT("Matilda_Icon"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Ui/PlayerIcon/Chara_Portrait_SM.png"), 1))))
		return E_FAIL;
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_CHANGE_STAGE, TEXT("Amanda_Icon"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../Bin/Resources/Textures/Ui/PlayerIcon/Chara_Portrait_GS.png"), 1))))
		return E_FAIL;
