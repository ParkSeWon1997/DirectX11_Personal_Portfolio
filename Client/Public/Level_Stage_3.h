...
class CLevel_Stage_3 final : public CLevel
{
private:
	CLevel_Stage_3(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CLevel_Stage_3() = default;
...
private:
	...
	HRESULT Ready_Boss_UI(const wstring& strLayerTag);
	...
	HRESULT Ready_Layer_CutScene(const wstring& strLayerTag);
...
public:
	static CLevel_Stage_3* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
