...
{
private:
	CLevel_Stage_1(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CLevel_Stage_1() = default;
...
public:
	static CLevel_Stage_1* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
