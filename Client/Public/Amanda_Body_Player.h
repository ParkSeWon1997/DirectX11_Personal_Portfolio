...
class Amanda_Body_Player final : public CPartObject
{
public:
	typedef struct Amanda_BODY_DESC : public CPartObject::PARTOBJ_DESC
	{
		class CGameObject* m_pPlayer = nullptr;

	}Amanda_BODY_DESC;
private:
	Amanda_Body_Player(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	Amanda_Body_Player(const Amanda_Body_Player& rhs);
	virtual ~Amanda_Body_Player() = default;
...
public:
	static Amanda_Body_Player* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
